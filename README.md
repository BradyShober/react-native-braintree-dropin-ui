...
```bash
npm install react-native-braintree-drop-in-ui --save
```

### Mostly automatic installation

```bash
react-native link react-native-braintree-drop-in-ui
```
...
```javascript
import BraintreeDropIn from 'react-native-braintree-drop-in-ui';
